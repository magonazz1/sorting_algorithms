...
/**
 * print_left_right - function will print left and right partitions
 * @array: array
...
/**
 * mergeSort - array separator function
 * @cpy: copy of array
 * @first: initial position
...
/**
 * copy_array - copy array of integer
 * @arr: array src
 * @cpy: array dest
 * @size : array size
 */
...
/**
 * merge_sort - creates a partition and copy
 * @array: array
 * @size : array size
 */
